	...
	<div class="container pt-3 justify-content-center">
		...
		<h2>Add Component</h2><br>	
			<div class="form-group">
				<input type="hidden" value="${component.getComponentId()}" name="id" />
				<label>Part number:</label><br>
				<input type="text" class="form-control" name="partNumber"  value="${component.getPartNumber()}" style="width:50%" required/>
				<div class="valid-feedback">Valid.</div>
    			<div class="invalid-feedback">Please fill out this field.</div>
    		</div>
    		<label>Select manufacturer:</label><br>
			<select  name="manufacturerId" class="custom-select" style="width:50%">
				<option selected value="${component.getManufacturer().getManufacturerId()}">${component.getManufacturer().getManufacturerName()}</option>
			...
			<select name="supplierId" class="custom-select" style="width:50%">
				<option selected value="${component.getSupplier().getSupplierId()}">${component.getSupplier().getSupplierName()}</option>
    		...
    		<div class="form-group">
    			...
    			<input type="text" class="form-control" name="description"  value="${component.getPartNumber()}" style="width:50%" required/>
				<div class="valid-feedback">Valid.</div>
